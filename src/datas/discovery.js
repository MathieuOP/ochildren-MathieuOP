        ...
        pics: [
          {
            ...
            desc: '',
            image_url:
              'https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/edb33749110005.58ab71bf52e1c.png'
          },
          {
            name: 'Les Observatoires',
            desc:
              "Situés généralement en altitude, loin des sources de pollution lumineuse pour bénéficier d'une meilleure transparence de l'atmosphère. En astronomie, on désigne généralement par observatoire au sol les observatoires dont les télescopes et leurs instruments associés sont dédiés à l'étude des astres. Il existe dans le monde une grande variété d'observatoires astronomiques.",
            image_url: 'https://image.flaticon.com/icons/svg/231/231142.svg'
          },
          {
            name: 'La Fusée',
            desc:
              "La première fut inventée en Chine au 13eme siécle. Ce fut d'abord une arme, bien loins de notre vision spatial d'aujourd'hui. Ensuite, en 1893, le Russe Konstantin Tsiolkovski imagine le fonctionnement de la fusée spatiale. En 1957, la fusée Semyorka conçue par le Russe Serguey Korolev met en orbite le tout premier satellite Spoutnik 1.",
            image_url: 'https://image.flaticon.com/icons/svg/639/639373.svg'
          },
          {
            name: 'Le Radiotéléscopre',
            desc:
              'Un radiotélescope est un télescope spécifique utilisé en radioastronomie pour capter les ondes radioélectriques émises par les astres. On les utilise aussi bien pour étudier le Soleil, que pour celles des régions de formation stellaires (les galaxies) ou des études du Cosmos',
        ...
        pics: [
          {
            ...
            desc: '',
            image_url:
              'https://telesel.ch/wp/wp-content/uploads/2017/08/a7c4b20e9bf9c64ce9b455a5f2e371a9-space-stars-background.jpg'
          },
          {
            name: 'Le Soleil',
            desc:
            ...
            image_url:
              'https://www.flaticon.com/premium-icon/icons/svg/1146/1146310.svg'
          },
          {
            name: 'Mercure',
            desc:
              "Mercure est la plus petite planète du système solaire et la plus proche du Soleil, avec une période de révolution de 88 jours (c'est la plus rapide du système solaire). Sa proximité avec le soleil rend son observation depuis la Terre difficile, il n'est possible de l'observer qu'au lever ou au coucher du Soleil",
            image_url: 'https://image.flaticon.com/icons/svg/1086/1086084.svg'
          },
          {
            name: 'Venus',
            desc:
              "Vénus est la deuxième planète la plus proche du Soleil, et la sixième plus grosse. Cette planète rocheuse, légèrement plus petite et moins massive que la Terre, est la plus chaude du système solaire. On appelle aussi Vénus l'étoile du berger. Son nom lui vient de la déesse romaine Vénus",
            image_url: 'https://image.flaticon.com/icons/svg/1266/1266586.svg'
          },
          {
            name: 'La Terre',
            desc:
              'Troisième planète du Système solaire et cinquième plus grosse, la Terre est la seule planète connue sur laquelle se trouve des êtres vivants. La révolution de la Terre autour du Soleil, dure 365 jours et 6 heures. La Terre accomplit une rotation sur elle-même en 23 heures et 56 minutes et 4,1 secondes (et non 24 heures). Mais, comme elle avance sur son orbite autour du Soleil de 1 degré par jour, elle a effectivement besoin de 24 heures pour rattraper son "retard". La Terre est parfois appelée Gaïa, en souvenir de la déesse grecque de la fertilité de la terre et du sol.',
          ...
          },
          {
            name: 'Le Satellite',
            desc:
              "Un satellite artificiel est un objet fabriqué par l'Homme, envoyé dans l'espace à l'aide d'une fusée spatiale et tournant autour de la Terre. Le premier satellite artificiel, nommé Spoutnik 1, a été mis en orbite autour de la Terre par l'URSS en 1957.",
...

      {
        ...
        pics: [
          ...
          },
          {
            name: 'Saturne',
            desc:
              "Saturne est la sixième planète tournant autour du Soleil. D'un diamètre neuf fois supérieur à celui de la Terre, Saturne est très connue pour ses anneaux spectaculaires composés de morceaux de glace. C'est la plus lointaine planète visible à l'œil nu, et la dernière connue jusqu'à ce qu'Uranus soit découverte au xixe siècle. En anglais, Saturne a donné son nom à Saturday, ce qui signifie samedi, le sixième jour de la semaine.",
            image_url: 'https://image.flaticon.com/icons/svg/1751/1751904.svg'
          },
          {
            name: 'Jupiter',
            desc:
              "Jupiter est la 5e planète du système solaire, et la plus grande, avec un diamètre de 11 fois celui de la Terre et un volume 1 320 fois plus important. Sa masse n'est en revanche \"que\" de 318 fois celle de la Terre, car c'est une géante gazeuse.La planète est connue depuis la Préhistoire : elle est visible à l'œil nu, comme une étoile très brillante, mais qui ne scintille pas : c'est en effet l'un des objets les plus lumineux du ciel nocturne (avec la Lune et Vénus).",
            image_url: 'https://image.flaticon.com/icons/svg/124/124558.svg'
          },
          {
            name: 'Mars',
            desc:
              "Située à environ 228 millions de kilomètres du Soleil, Mars est la quatrième planète du Système solaire et la deuxième plus petite, après Mercure. Sa couleur rouge est donnée par l'abondance d'oxyde de fer (rouille) sur sa surface.",
...

      {
        ...
        pics: [
          ...
          },
          {
            name: 'Uranus',
            desc:
              "Uranus est la septième planète du système solaire. C'est une géante gazeuse, composée principalement d’hydrogène et d’hélium, tout comme les trois autres géantes gazeuses Jupiter, Saturne et Neptune. Son nom vient de l'adaptation latine du nom Ouranos (grec Οὑρανός), le dieu du ciel, une des divinités primordiales de la mythologie grecque. Elle a été découverte par l'astronome britannique William Herschel le 13 mars 1781. C'est la première planète invisible à l'œil nu qui a été découverte, la plus éloignée visible à l’œil nu étant Saturne.",
...

      {
        ...
        pics: [
          ...
          },
          {
            name: 'Professeur Al',
            desc:
              "Grâce aux microscopes, on peut voir l'infiniment petit. C'est grâce à eux que l'on peut etudier les bactéries, les virus, les atomes, les cellules d'un corps et l'ADN.",
            image_url: 'https://image.flaticon.com/icons/svg/843/843255.svg'
          },
          {
            name: 'Les Bactéries',
            desc:
              "Les bactéries (Eubacteria) sont des êtres vivants composés d'une seule cellule (unicellulaires). Ce sont des micro-organismes (autrefois appelés microbes).Il en existe des bénéfiques pour l'homme et d'autres peuvent causer des maladies infectieuses (on dit qu'elles sont pathogènes)",
      ...
      },
      {
        ...
        pics: [
          ...
          },
          {
            name: 'Professeur Al',
            desc:
              "Grâce à la découverte des molecules et des atomes, la chimie, et son évolution, nous a aidé a fabriquer de nombreux vaccins et médicaments. De nos jours, on utilise la chimie au quotidien! C'est à dire dans chaque produit que l'on consomme, la chimie joue un rôle cruciale. ",
            image_url: 'https://image.flaticon.com/icons/svg/843/843255.svg'
          },
          {
        ...
        pics: [
          {
            ...
            desc: '',
            image_url:
              'https://i0.wp.com/static.vecteezy.com/system/resources/previews/000/206/763/original/awesome-tropical-landscape-player-vectors.jpg'
          },
          {
            name: 'Le soleil',
        ...
        pics: [
          {
            ...
            desc: '',
            image_url:
              'https://storybookstorage.s3.amazonaws.com/items/images/000/705/776/original/20170122-7-1tpunb3.jpg'
          },
          {
            name: 'Le Tigre',
            desc:
          ...
          },
          {
            name: 'Le Toucan',
            desc:
              "Le toucan est un oiseau d'Amérique centrale et du Sud, ressemblant au calao. Il est multicolore et il a un grand bec. Il en existe plusieurs espèces, dont le toucan toco.",
            image_url: 'https://image.flaticon.com/icons/svg/375/375082.svg'
          },
          {
            name: 'La Panthère Noire',
            desc:
              "La panthère noire est un mammifère carnassier (qui se nourrit de viande crue) d'Afrique et d'Asie. Il s'agit en fait d'un léopard au pelage sombre (mélanisme). Elle fait partie des félins. La panthère est tout le contraire de son cousin le guépard qui se laisse apprivoiser facilement. Elle préfère être solitaire et ne vit pas en groupe.",
            image_url: 'https://image.flaticon.com/icons/svg/371/371654.svg'
          },
          {
            name: 'Les Libellule',
            desc:
              "On les trouve fréquemment près des zones d'eau douce notamment les mares. Les libellules ont un corps allongé, en forme de bâton. Elles ont quatre grandes ailes, membraneuses. Les libellules ne peuvent pas replier complètement les ailes sur leur dos, comme la plupart des autres insectes. Quand elles sont posées, elles gardent les ailes grandes ouvertes, ce qui les rend très reconnaissables et leur permet également de très vite s'échapper jusqu'à 90 km/h (c'est l’insecte le plus rapide). Elles mesurent quelques centimètres de long de 4 à 5 centimètres.",
            image_url: 'https://image.flaticon.com/icons/svg/184/184979.svg'
          },
          {
            name: 'Le Singe',
            desc:
              "Hello je suis un singe! En Anglais, on m'appel aussi Monkey ou Ape",
            image_url: 'https://image.flaticon.com/icons/svg/852/852071.svg'
          },
          {
            name: 'Le Papillon',
            desc:
              "Le papillon est d'abord une chenille. C'est une fois que la chenille a bien mangé, qu'elle s'entoure d'un cocon fait de fil de soie, pour devenir un papillon. Avant de devenir un papillon, la chenille peut rester de 15 jours à 2 ans à l'interieur du cocon",
...
export const selectId = ({ name, id }) =>
  data.find(elem => elem.name === name).cards.find(eId => eId.id === id);
