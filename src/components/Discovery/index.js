    ...
    return (
      <main className="discovery">
        ...
        <p className="discovery--description">
          Discovery est un livre interactif. Avec lui, tu decouvriras different
          thèmes!
        </p>
            ...
            >
              ...
              <Modal.Content image>
                ...
                <Modal.Description>
                  ...
                  <p>
                    Embarquement immédiat pour un visite de notre système
                    solaire à bord de notre fusée!{' '}
                  </p>
                  <br />
                  <p>
                    Avec le space Discovery, tu vas decouvrir l'origine de la
                    Terre, de quoi est composé l'espace ainsi que les planètes
                    les plus proche de nous.
                  </p>
                </Modal.Description>
              </Modal.Content>
              <Modal.Actions>
                <Button color="red" onClick={this.close1} size="large">
                  Retour
                </Button>
            ...
            >
              ...
              <Modal.Content image>
                ...
                <Modal.Description>
                  ...
                  <p>
                    Si tu veux découvrir de quoi se compose un laboratoire, voir
                    des bactèries en grand et comprendre comment sont fait nos
                    médicament?
                  </p>
                  <br />
                  <p>C'est par ici!!</p>
              ...
              <Modal.Actions>
                <Button color="red" onClick={this.close2} size="large">
                  Retour
                </Button>
            ...
            >
              ...
              <Modal.Content image>
                ...
                <Modal.Description>
                  ...
                  <p>
                    Et oui! C'est bien beau de voyager dans l'espace, de voir
                    l'infiniment petit, mais il faut aussi avoir les pieds sur
                    terre.
                  </p>
                  <p>
                    Tellement de beaux paysages et d'espèce composent notre
                    planète.
                  </p>
                  <p>
                    Que serait l'homme sans les animaux? Et que serait les
                    animaux sans la nature?
                  </p>
                  <p />
                  <br />
              ...
              <Modal.Actions>
                <Button color="red" onClick={this.close3} size="large">
                  Retour
                </Button>
                <Link
    ...
    >
      <Route
        ...
        render={({ match }) => {
          ...
          return <Theme cardId={parseInt(cardId, 10)} themeName={theme} />;
        }}
      />
    </Suspense>
  </Switch>
